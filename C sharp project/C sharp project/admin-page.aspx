<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin-page.aspx.cs" Inherits="C_sharp_project.admin_page" %>
...
<body>
  ...
  <div class="container-fluid">
    ...
    <div style="display:inline-block; margin-left:10%" ><img  src="home-images\Admin-bro.png" width="70%" height="400px"/> </div>
    <div style="display:inline-block; margin-left:5%">
        <h4>What You Can do ?</h4>
        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/" class="hyperlink">-See all employee's Survey. </asp:HyperLink>
        <br />
        <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/"  class="hyperlink">-Create Survey.</asp:HyperLink>
